...
SUBROUTINE ACRANEB2( &
! - INPUT
 & YDERDI,YDRIP,YDML_PHY_MF,KIDIA,KFDIA,KLON,KTDIA,KLEV, &!KJN, &
! - INPUT 2D
 & KSTEP,PAPRS,PAPRSF,PCP,PR,PDELP,PNEB,PQ,PQCO2,PQICE,PQLI,PQO3,PT, &
! - INPUT 1D
...
!USE ACRANEB_TRANSS_MOD, ONLY : ACRANEB_TRANSS
!USE ACRANEB_TRANST_MOD, ONLY : ACRANEB_TRANST
...
INTEGER(KIND=JPIM) :: ILEV,ICALS,ICALT,ISTEP
INTEGER(KIND=JPIM) :: JAE,JLEV,JLEV1,JLEV2,JLON,JSTEP

! LOCAL LOGICAL SCALARS
LOGICAL :: LLAUTO,LLREWS
...
REAL(KIND=JPRB) :: ZARGLI,ZTRLI,ZEARRT,ZDEBL,ZW,&
  ...
  & ZEFFE2,ZTARE2,ZDEL1,ZDEL2,ZFTPP,ZTARSP,ZUSA,ZZEO2TA,ZZEO2SA,ZHOOK_HANDLE
...
CALL ACRANEB_COEFT(KIDIA,KFDIA,KLON,KTDIA,KLEV,&
 & PDELP,ZDEOTI2(1,1),ZEO1TI,ZEO2TI,ZEO1TN,ZEO2TN,ZQICE,&
...
CALL ACRANEB_COEFT(KIDIA,KFDIA,KLON,KTDIA,KLEV,&
 & PDELP,ZUEOTI2(1,1),ZEO1TI,ZEO2TI,ZEO1TN,ZEO2TN,ZQICE,&
 & ZQLI,ZEO1TA,ZEO2TA,ZA4C,ZA5C,ZA4N,ZA5N)
...
CALL ACRANEB_COEFT(KIDIA,KFDIA,KLON,KTDIA,KLEV,&
 & PDELP,ZEOTI(1,1),ZEO1TI,ZEO2TI,ZEO1TN,ZEO2TN,ZQICE,&
 & ZQLI,ZEO1TA,ZEO2TA,ZA4C,ZA5C,ZA4N,ZA5N)
